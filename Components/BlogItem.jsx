...
const BlogItem = ({ title, category, description, image, id }) => {
  return (
    <div className="max-w-82.5 sm:max-w-95 bg-white border pb-6 border-black hover:shadow-[-7px_7px_0px_rgba(0,0,0,0.8)] transition-shadow duration-300 ease-in-out">
      <Link href={`/blogs/${id}`}>
        <Image
          src={image}
          alt=""
